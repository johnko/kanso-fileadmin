...
/*============================================================================*/
var MetaFileIcon = React.createClass({displayName: "MetaFileIcon",
    previewShow: function(event) {
        ...
        if($.trim($(divid).html())==='') {
            if (this.props.type.match(/image/)) {
                ...
                var erase2 = this.props.name.match(/.*\/youtu\.be\//);
                var youtubevideoid2 = this.props.name.replace(
                    erase2,''
                ).match(/[0-9a-zA-Z]{11}/);
                $(divid).append(
                $('<iframe></iframe>').attr({
...
/*============================================================================*/
var TagTableRow = React.createClass({displayName: "TagTableRow",
    toggleTick: function() {
    ...
    render: function() {
        ...
        if (this.props.size!==0) {
            cellsize = (
                React.createElement("td", {className: "tablenumber"},
        ...
        if (this.props.time) {
            celltime = (
                React.createElement("td", {className: "tabletime"},
                    React.createElement("span", {
                        className: "pull-left"},
        ...
        if (this.props.name.match(/https?:\/\/.*/)) {
            ...
            externalurl = (
                React.createElement("a", {href: eurl}, eurl)
            );
        } else {
            if (!isFile(this.props)) {
                tagscount = (
        ...
        return (
            React.createElement("tr", {className: "tagitem "+doneClass},
                React.createElement("td", null,
                    doneornot
                ),
                React.createElement("td", {className: "tabletype"},
                    typeicon
                ),
                React.createElement("td", {className: "tagname"},
                    React.createElement("a", {
...
/*============================================================================*/
var TagsTable = React.createClass({displayName: "TagsTable",
...
"DONE"
                        ...
                        React.createElement("th", {className: "tabletype"},
                            React.createElement("button", {
                                type: "button",
...
/*============================================================================*/
var TagsOuter = React.createClass({displayName: "TagsOuter",
    ...
    render: function() {
        //if (this.state.data.length > 0) {
            ...
            switch(this.state.viewas) {
                ...
                default:
                    viewTagsAs = (
                        React.createElement(TagsListB, {data: this.state.data})
                    );
                    var classObj = {
                        "done":'',
                        "type":'',
                    ...
                    tagSortBar = (
                        ...
                        className: "glyphicon glyphicon glyphicon-sort",
                        "aria-hidden": "true"}
                                    ), React.createElement("span", {className: "btnlabel"},
"Type"
                                    )
                                ),
                                React.createElement("button", {
...
"Add tag"
            ...
            if (getHashFromLocation()) {
                return (
                    React.createElement("div", {className: "tagsouter"},
                        React.createElement("h4", null, this.props.title),
                        addtagform,
                        React.createElement("div", {className: "pull-left tagoptions"},
                            React.createElement("div", {
                                className: "btn-group",
                                role: "group",
                                "aria-label": "..."},
...
/*============================================================================*/
var TagListBButton = React.createClass({displayName: "TagListBButton",
    render: function() {
        var typeicon = (
            React.createElement(MetaFileIcon, {
                hash: this.props.hash,
        ...
        if (this.props.name.match(/https?:\/\/.*/)) {
            ...
            externalurl = (
                React.createElement("li", null, React.createElement("a", {href: eurl}, eurl))
            );
            //has external url
            dropdown = (
        ...
        return (
            React.createElement("li", {className: "tagitem"},
                React.createElement("div", {className: "tagwrapper"},
                    React.createElement("div", {className: "tagtop"},
                        typeicon,
                        dropbutton,
                        mainbutton,
                        dropdown
...
/*============================================================================*/
var TagsListB = React.createClass({displayName: "TagsListB",
    render: function() {
        var tagNodes = [];
        this.props.data.forEach(function(o) {
            if ( (o.name) && (o.time) ) {
        ...
        return (
            React.createElement("ul", {className: "taglist"},
                tagNodes
            )
        );
    }
